...
public class JsonInMemoryParsing {
    ...
    public static void main(String[] args) throws Exception {
      ...
      while(parser.hasNext()) {
           ...
           switch(evt) 
           {
           case START_ARRAY:arrays++;break;
           case START_OBJECT:objects++;break;
           case KEY_NAME:keys++;break;
               
           case VALUE_FALSE: literals++;break;
           case VALUE_TRUE:literals++;break;
           case VALUE_NULL:literals++;break;
               
           case VALUE_NUMBER:numbers++;break;
           
           case VALUE_STRING:strings++;break;
           }
